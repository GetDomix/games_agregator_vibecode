...
type Props = { favorites: FavoriteItem[]; alerts: AlertItem[]; onEdit: (favorite: FavoriteItem) => void; onRearm: (alert: AlertItem) => Promise<void>; onSearch: (name: string, appid: number) => void; onRemove?: (alert: AlertItem) => void | Promise<void> }
