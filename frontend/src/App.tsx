        ...
        {view === 'home' && (
          <>
            <section className="hero">
              ...
              <p className="lead">
                KeySignal показывает официальную цену Steam и рыночные предложения на Plati.Market и GGsel:
                минимум, среднюю и ссылки на популярные офферы. Удобно решить, где выгоднее купить, и сохранить цель в избранном.
              </p>
              <form
            ...
            <section className="section panel">
              ...
              <div className="steps">
                <div className="step">
                  ...
                  <p>Не нужно открывать три вкладки и вручную сопоставлять названия товаров.</p>
                </div>
                <div className="step">
                  <h4>Понятная выгода</h4>
                  <p>Оценка сделки относительно Steam и разбивка по типам: ключ, гифт, аккаунт, аренда.</p>
                </div>
                <div className="step">
                  <h4>Следи за ценой</h4>
                  <p>Аккаунт сохраняет историю и избранное с целевой ценой — вернёшься, когда станет дешевле.</p>
                </div>
              </div>
            </section>
          ...
          <section className="section hero">
            ...
            <div className="steps" style={{ marginTop: '1.25rem' }}>
              <div className="step">
                ...
                <p>Лучше точное название, как в Steam. Можно выбрать совпадение из списка подсказок.</p>
              </div>
              <div className="step">
                <h4>2. Сравните</h4>
                <p>Смотрите цену Steam, минимум и среднюю на Plati и GGsel, тип товара и ссылку на оффер.</p>
              </div>
              <div className="step">
                <h4>3. Сохраните</h4>
                <p>В аккаунте — история и избранное с целевой ценой. Кнопка «Обновить» подтянет актуальные цены.</p>
              </div>
            </div>
            <p className="lead" style={{ marginTop: '1.25rem' }}>
              Цены ориентировочные и зависят от продавца, региона и наличия. Перед оплатой всегда проверяйте карточку на площадке.
              Рекламные блоки и партнёрские ссылки помогают развивать сервис.
            </p>
